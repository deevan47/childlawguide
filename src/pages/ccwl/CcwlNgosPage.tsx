...
import ngoBg from "../../assets/images/justicebg.png";
import ngoMascot from "../../assets/images/bjudge.png";
...
const NGO_DATA = {
  legal: {
    ...
    steps: [
      {
        id: 1,
        text: "Providing free legal counsel to children who cannot afford lawyers.",
        img: img1,
      },
      {
        id: 2,
        text: "Ensuring the child understands the legal proceedings in a child-friendly manner.",
        img: img2,
      },
      {
        id: 3,
        text: "Monitoring that the child's rights are not violated during police apprehension or inquiry.",
        img: img3,
      },
    ],
  },
  rehab: {
    ...
    steps: [
      {
        id: 1,
        text: "Conducting psycho-social counseling to address underlying behavioral issues.",
        img: img4,
      },
      {
        id: 2,
        text: "Organizing recreational and creative activities within Observation Homes.",
        img: img1,
      },
      {
        id: 3,
        text: "Providing drug de-addiction services and mental health support where needed.",
        img: img2,
      },
    ],
  },
  skill: {
    ...
    steps: [
      {
        id: 1,
        text: "Teaching practical skills (computers, carpentry, tailoring) to ensure future livelihoods.",
        img: img3,
      },
      {
        id: 2,
        text: "Bridging educational gaps through non-formal education programs.",
        img: img4,
      },
      {
        id: 3,
        text: "Collaborating with local businesses for apprenticeship opportunities post-release.",
        img: img1,
      },
    ],
  },
  social: {
    ...
    steps: [
      {
        id: 1,
        text: "Preparing the family and community to accept the child back without stigma.",
        img: img2,
      },
      {
        id: 2,
        text: "Conducting follow-up visits to ensure the child does not re-offend.",
        img: img3,
      },
      {
        id: 3,
        text: "Linking the child with government welfare schemes for financial stability.",
        img: img4,
      },
    ],
  },
